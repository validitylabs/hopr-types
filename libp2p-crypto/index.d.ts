declare module 'libp2p-crypto' {
  ...
  export namespace keys {
    ...
    export function generateEphemeralKeyPair(curve: any): Promise<any>

    export function unmarshalPublicKey(buf: Buffer): Promise<any | Secp256k1PublicKey>

    export function marshalPublicKey(key: any, type: any): Buffer

    export function unmarshalPrivateKey(buf: Buffer): Promise<Secp256k1PrivateKey>
